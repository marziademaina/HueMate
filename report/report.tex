...
\begin{figure}[H]
    ...
    \text{crediti figura \ref{fig:alterazioni}: Università Vita-Salute San Raffaele, https://blog.unisr.it/alterazioni-senso-cromatico}
...
\begin{itemize} 
    ...
    \item[-] \textbf{LICENSE}: il file di licenza sotto cui è rilasciato HueMate.
\end{itemize}
